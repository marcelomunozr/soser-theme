                ...
                <header>
                    ...
                    <ul class="nav <?php if ( is_home()|| is_front_page() || is_page( 'rico-y-sano' )){ echo 'sub-menu-important';} ?> nav-justified" id="menu">
                        ...
                        <li class="expand li-class"><a href="/trabaja-con-nosotros/">Trabaja en Soser</a>
                            <ul class="sub-menu">
                                <li><a href="http://www.soser.trabajando.com/ingresocv.cfm" target="_blank">Ingresar CV</a></li>
                                <li><a href="http://www.soser.trabajando.com/verOfertas.cfm" target="_blank">Ver Ofertas</a></li>
                                <li class="rrhh"><a href="http://www.soser.trabajando.com/empresas/" target="_blank">Acceso RRHH</a></li>
                            </ul>
                        </li>
